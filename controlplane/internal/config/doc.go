...
//
// TODO(A7): DialTimeoutMS (timing.go) belongs to A7 and is hosted here only because runStreamTimeoutMs
// cannot be written without it. Case 25's two TTL formulas are likewise reproduced inside
// config_test.go. Rebind both when A7 lands.
