...
//	controlplane/internal/audit/canon_test.go findUpwards("control-plane/src/test/...")     — walks up
//	controlplane/internal/conformance         findUpwards(...) — same walk, same doomed suffix
//
