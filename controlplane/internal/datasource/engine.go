...
//
// Its ONLY job is to supply adoptHeldContent at every registry entry point. TODO(A10)/TODO(A7): four
// call sites — gRPC open + recover, and RunExec's editor/approval-exec paths. Wiring it into only
// the gRPC path silently forces a full fetch on every editor session.
