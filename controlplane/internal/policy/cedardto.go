...
// a 500 common.fallback through StatusPages, not a 400 — reproduced by the route rather than here,
// because the route is where the Kotlin's choice of catch (or lack of one) is observable.
