...
Computed at `TOKEN_TTL_GRACE_SECONDS = 300` (#160 raised it from 180) and
`TTL wanted = max(RUN_TOKEN_TTL_FLOOR_SECONDS, q + grace)`:

| `PM_QUERY_TIMEOUT` | TTL wanted | TTL **stored** | margin       | outlives query?                    |
| ------------------ | ---------- | -------------- | ------------ | ---------------------------------- |
| 600                | 900        | 900            | +300         | ✅                                 |
| 86,100 (23h55m)    | 86,400     | 86,400         | +300         | ✅ last point the full grace holds |
| 86,220             | 86,520     | 86,400         | +180         | ⚠️ grace silently eroded           |
| 86,400 (24h)       | 86,700     | 86,400         | **0**        | ⚠️ token dies exactly at timeout   |
