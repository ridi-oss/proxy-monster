...
func main() {
	...
	// The background IdP liveness sweep (App.kt:430-443's loop 2). Started before the blocking serve
	// and stopped by Shutdown; it is the sole revalidator of web and daemon sessions against the IdP.
	a.StartLivenessSweep()
