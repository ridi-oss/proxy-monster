...
// KT: ChannelContextAuthzTest.kt#a channel-conditioned grant fires only for the matching channel
...
// KT: ChannelContextAuthzTest.kt#the same grant does not apply on a different channel
...
// KT: ChannelContextAuthzTest.kt#an absent channel fails the guard closed
...
// KT: ChannelContextAuthzTest.kt#an unguarded optional-attr policy is rejected at engine construction
