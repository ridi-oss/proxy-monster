...
// KT: AuthzDatasourceActionTest.kt#a granted role may connect to the named datasource
...
// KT: AuthzDatasourceActionTest.kt#a granted role may run a granted sql kind on the named datasource
...
// KT: AuthzDatasourceActionTest.kt#sql-unmaskable follows the preset-development datasource tag
...
// KT: AuthzDatasourceActionTest.kt#an ungranted sql kind is denied — deny-by-default, not absent-equals-allow
...
// (INV-A2-2)
// KT: AuthzDatasourceActionTest.kt#the same grant on a different datasource name does not apply — NAME-keyed, not blanket
...
// KT: AuthzDatasourceActionTest.kt#no roles at all is denied
