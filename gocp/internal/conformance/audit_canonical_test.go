...
//
//	Same fixture, same six vectors, same two assertions (canonical bytes, then row hash). Split with
//	internal/audit TestGoldenVectorsThroughTypesAuditEvent, which replays it through the wire-type
//	conversion instead of the canon types.
