...
func withGeneration(g uint64) pushOpt {
	return func(p *pb.SchemaFragmentPush) { p.BackendGeneration = g }
}
...
// case 1 — 🔒 INV-A5-25
// KT: PerConnectionCatalogStateTest.kt#minted ids are 16 bytes and collisions retry
...
// case 2 — 🔒 INV-A5-30
// KT: PerConnectionCatalogStateTest.kt#pending is the push CAS and replay cannot regress authoritative
...
// case 3 — rung 3
// KT: PerConnectionCatalogStateTest.kt#backend generation binds and old pushes reject
...
// case 4 — INV-A5-34
// KT: PerConnectionCatalogStateTest.kt#authoritative ordering follows accepted observation order including revert
...
// KT: PerConnectionCatalogStateTest.kt#a hash marker quiets one authoritative version and retriggers on the next
...
// case 6
// KT: PerConnectionCatalogStateTest.kt#unchanged adoption shares pooled fragment and refreshes staleness clock
...
// case 7 — INV-A5-28
// KT: PerConnectionCatalogStateTest.kt#adopting held content opens with no fetch and decides immediately
...
// case 8 — 🔒 INV-A5-27
// KT: PerConnectionCatalogStateTest.kt#adoption inherits the original measurement time so staleness still fires
...
// case 9 — INV-A5-44
// KT: PerConnectionCatalogStateTest.kt#an ambient refresh re-measures pooled content so adopters stay fresh
...
// case 10 — 🔒 INV-A5-41
// KT: PerConnectionCatalogStateTest.kt#an ambient refresh whose columns differ never overwrites pooled content
...
// KT: PerConnectionCatalogStateTest.kt#adopting retains the pooled fragment so it survives the original holder closing
...
// case 12 — INV-A5-28
// KT: PerConnectionCatalogStateTest.kt#a schema with nothing held is still fetched when adopting
...
// case 13 — 🔒 INV-A5-31
// KT: PerConnectionCatalogStateTest.kt#unchanged on-open cannot no-op an unconditional first fetch
...
// case 14 — 🔒 INV-A5-35
// KT: PerConnectionCatalogStateTest.kt#system schema fragments dedup across datasources on the same engine version
...
// case 15 — 🔒 INV-A5-45
// KT: PerConnectionCatalogStateTest.kt#invalidating a datasource forces the next connection to measure for itself
...
// case 16 — 🔒 INV-A5-42
// KT: PerConnectionCatalogStateTest.kt#one datasource's ambient refresh cannot vouch for another's schema
...
// KT: PerConnectionCatalogStateTest.kt#same hash with different columns rejects and close is idempotently fail-closed
