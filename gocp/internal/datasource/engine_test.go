...
// case 1
// KT: EnginesTest.kt#engineFromWire accepts the canonical spellings, case-insensitively
...
// case 2 — 🔒 INV-A5-7
// KT: EnginesTest.kt#engineFromWire is fail-closed on unknown engines and the postgresql alias
...
// case 3
// KT: EnginesTest.kt#EngineWireSerializer round-trips as the exact wire string — Kotlin's kotlinx EngineWireSerializer is Marshal/UnmarshalEngineJSON here; the asserted wire bytes are identical
...
// case 4
// KT: EnginesTest.kt#wireName and dialect are the canonical mappings
...
// case 5
// KT: EnginesTest.kt#catalogName, defaultSchema and resolveSchema follow each engine's namespace model
...
// KT: EnginesTest.kt#value-returning engine methods fail closed on an unspecified engine — Kotlin's IllegalStateException is a non-nil error here; same six entry points
...
// case 7
// KT: EnginesTest.kt#systemSchemas is the concrete enumerable set per engine
...
// case 8
// KT: EnginesTest.kt#MySQL system schemas match case-insensitively
...
// case 9
// KT: EnginesTest.kt#MySQL non-system schema does not match
...
// case 10
// KT: EnginesTest.kt#Postgres system schemas require exact lowercase spelling, unlike MySQL
...
// case 11
// KT: EnginesTest.kt#Postgres temp and toast schemas match isSystemSchema by prefix but are not fixed
...
// case 12
// KT: EnginesTest.kt#isFixedSystemSchema keeps each engine's casing but drops the prefixes
...
// case 13
// KT: EnginesTest.kt#Postgres non-system schema does not match
