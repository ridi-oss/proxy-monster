...
var wantHistory = []struct{ version, description, script string }{
	...
	{"13", "datasource soft delete", "V13__datasource_soft_delete.sql"},
	{"14", "role maskfn soft delete", "V14__role_maskfn_soft_delete.sql"},
	{"15", "group soft delete", "V15__group_soft_delete.sql"},
	{"16", "policy soft delete", "V16__policy_soft_delete.sql"},
	{"17", "notifications", "V17__notifications.sql"},
	{"18", "statement category presets", "V18__statement_category_presets.sql"},
	{"19", "rename exception gates", "V19__rename_exception_gates.sql"},
	{"20", "statement predicate literals", "V20__statement_predicate_literals.sql"},
	{"21", "explain unmasked preset", "V21__explain_unmasked_preset.sql"},
	{"22", "notification kind", "V22__notification_kind.sql"},
	{"23", "result error detail", "V23__result_error_detail.sql"},
}
...
//
// It starts (or reuses) the shared container, creates a fresh database, runs every migration
