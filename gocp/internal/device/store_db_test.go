...
// KT: DeviceLoginStoreDbTest.kt#create then get round-trips a pending row
...
// KT: DeviceLoginStoreDbTest.kt#unknown handle is absent
...
// KT: DeviceLoginStoreDbTest.kt#a login is retrievable by its user_code and a fresh one is well-formed
...
// KT: DeviceLoginStoreDbTest.kt#markApproved sets status and principal, only once
...
// KT: DeviceLoginStoreDbTest.kt#markApproved refuses an expired handle
...
// KT: DeviceLoginStoreDbTest.kt#purgeExpired removes only expired rows
