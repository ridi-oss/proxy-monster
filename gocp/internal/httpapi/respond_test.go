...
func TestReceiveIgnoresUnknownKeys(t *testing.T) {
	...
	// Receive gates on Content-Type (ContentNegotiation's 415 arm), so a fixture that omits it is
	// measuring the wrong thing — this case is about unknown-key tolerance.
