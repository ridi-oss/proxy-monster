...
//
// KT: DebugRequesterIpDbTest.kt#a malformed address is refused rather than silently ignored — the positive-control half (the five accepted literals)
...
//
// KT: DebugRequesterIpDbTest.kt#a malformed address is refused rather than silently ignored — the eleven-literal rejection corpus; the route's 400 shape and the nothing-behind claim are internal/app's
