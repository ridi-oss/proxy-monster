...
func TestEmbeddedMigrationSetIsComplete(t *testing.T) {
	want := []string{
		...
		"sql/V13__datasource_soft_delete.sql",
		"sql/V14__role_maskfn_soft_delete.sql",
		"sql/V15__group_soft_delete.sql",
		"sql/V16__policy_soft_delete.sql",
		"sql/V17__notifications.sql",
		"sql/V18__statement_category_presets.sql",
		"sql/V19__rename_exception_gates.sql",
		"sql/V20__statement_predicate_literals.sql",
		"sql/V21__explain_unmasked_preset.sql",
		"sql/V22__notification_kind.sql",
		"sql/V23__result_error_detail.sql",
	}
