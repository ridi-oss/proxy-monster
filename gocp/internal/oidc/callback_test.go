...
// KT: OidcCallbackTest.kt#OIDC continuation accepts only the co-hosted resume and reauth routes
...
// KT: OidcCallbackTest.kt#unconfigured oidc degrades both routes to 501
...
// KT: OidcCallbackTest.kt#provider error param redirects to error=oidc
...
// KT: OidcCallbackTest.kt#provider error preserves the popup reauth continuation
...
// KT: OidcCallbackTest.kt#state failure preserves the popup reauth continuation
...
// i18n fragment.
// KT: OidcCallbackTest.kt#provider error returns to the co-hosted OAuth resume route
...
// bad value.
// KT: OidcCallbackTest.kt#state mismatch redirects to error=state, and the state cookie is one-time-use
...
// KT: OidcCallbackTest.kt#invalid id_token redirects to error=nonce, and the nonce cookie is one-time-use
