...
// KT: OidcDiscoveryTest.kt#document parses every field, required and optional
...
// KT: OidcDiscoveryTest.kt#optional fields default to null when the IdP omits them
...
// KT: OidcDiscoveryTest.kt#a trailing slash on the configured issuer is tolerated
...
// KT: OidcDiscoveryTest.kt#the document is fetched once and cached across repeated calls
