...
// KT: OidcGroupMappingTest.kt#parse reads idpGroup=pmGroup pairs and ignores malformed entries
...
// KT: OidcGroupMappingTest.kt#an explicit mapping wins over the prefix rule
...
// KT: OidcGroupMappingTest.kt#an unmapped group is taken by name with the prefix stripped
...
// KT: OidcGroupMappingTest.kt#no prefix keeps unmapped names as-is
...
// KT: OidcGroupMappingTest.kt#a group that is blank after stripping the prefix is dropped
...
// KT: OidcGroupMappingTest.kt#the reserved system namespace is unreachable via the unmapped fallback
...
// KT: OidcGroupMappingTest.kt#an explicit mapping may target the reserved system namespace
