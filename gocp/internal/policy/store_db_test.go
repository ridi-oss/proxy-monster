...
// KT: BootstrapAdminDbTest.kt#isSystemRole protects the system-admin role wired into system-admin — the negative half: a plain role is not protected
...
// KT: BootstrapAdminDbTest.kt#isSystemRole protects the system-admin role wired into system-admin — the positive half, over all seven seeded groups
