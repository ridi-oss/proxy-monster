...
func TestCatalogCoverageGateDb(t *testing.T) {
	...
	// KT: CatalogCoverageGateDbTest.kt#postgres coverage miss denies on the floor, then a sql-unanalyzable permit relays it
	...
	// KT: CatalogCoverageGateDbTest.kt#mysql coverage miss denies on the floor, then a sql-unanalyzable permit relays it
