...
func TestDeactivationEnforcementDb(t *testing.T) {
	...
	// KT: DeactivationEnforcementDbTest.kt#a deactivated principal is denied instead of falling open to cleartext
	...
	// KT: DeactivationEnforcementDbTest.kt#a deactivated principal is denied even for a non-sensitive lineage query
	...
	// KT: DeactivationEnforcementDbTest.kt#a deactivated principal is denied even a READONLY_META passthrough (the gate dominates passthrough)
	...
	// KT: DeactivationEnforcementDbTest.kt#reactivating a principal restores normal enforcement
