...
func TestDiagnosticRedactionDecideDb(t *testing.T) {
	...
	// KT: DiagnosticRedactionDecideDbTest.kt#a system-development datasource never redacts (Cedar permits unmasked reads there)
	...
	// KT: DiagnosticRedactionDecideDbTest.kt#a production datasource redacts an ordinary principal, even on an ALLOW (Postgres whole-row leak)
