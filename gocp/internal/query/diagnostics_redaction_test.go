...
// KT: DiagnosticsRedactionTest.kt#MySQL ALLOW never redacts, whatever the principal
...
// KT: DiagnosticsRedactionTest.kt#MySQL ALLOW skips the Cedar unmasked-reader check (cannot leak on allow)
...
// KT: DiagnosticsRedactionTest.kt#MySQL MASK or DENY redacts unless the principal reads the datasource unmasked
...
// KT: DiagnosticsRedactionTest.kt#PostgreSQL redacts even an ALLOW unless the principal reads the datasource unmasked
...
// KT: DiagnosticsRedactionTest.kt#only PostgreSQL leaks diagnostics on an allowed query
