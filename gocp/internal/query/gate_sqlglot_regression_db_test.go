...
func TestGateSqlglotRegression(t *testing.T) {
	...
	// KT: GateSqlglotRegressionTest.kt#reference and membership oracles deny on both engines
	...
	// KT: GateSqlglotRegressionTest.kt#unknown table and UNION TABLE forms fail closed
	...
	// KT: GateSqlglotRegressionTest.kt#derived transforms redact while row-shaping use denies
	...
	// KT: GateSqlglotRegressionTest.kt#query-to-xml and session-state exfiltration stay closed
	...
	// KT: GateSqlglotRegressionTest.kt#cast or typed literal to a user type denies through the production walk
	...
	// KT: GateSqlglotRegressionTest.kt#schema-qualified user function denies through the production walk
	...
	// KT: GateSqlglotRegressionTest.kt#non-literal sql_mode assignment denies on MySQL
	...
	// KT: GateSqlglotRegressionTest.kt#MySQL ANSI_QUOTES masks a double-quoted pii column, default mode leaves it a string literal
	...
	// KT: GateSqlglotRegressionTest.kt#explain of query and reset master deny through the production walk
