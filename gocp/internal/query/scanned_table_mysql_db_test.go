...
func TestScannedTableMySql(t *testing.T) {
	...
	// KT: ScannedTableMySqlTest.kt#count(star) on an ungranted table is denied
	...
	// KT: ScannedTableMySqlTest.kt#count(star) on a table the principal can read is allowed
	...
	// KT: ScannedTableMySqlTest.kt#a pure CTE shadow of the ungranted table is allowed
	...
	// KT: ScannedTableMySqlTest.kt#a CTE body scanning the real ungranted table is denied
