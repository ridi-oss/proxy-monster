...
// KT: StatementFactsGrantLoopTest.kt#all-granted analyzed statement allows
func TestStatementFactsGrantLoop(t *testing.T) {
	...
	// KT: StatementFactsGrantLoopTest.kt#masked verdict with MASK_OUTPUT applies the configured mask
	...
	// KT: StatementFactsGrantLoopTest.kt#masked verdict with REDACT_OUTPUT_NULL redacts to NULL
	...
	// KT: StatementFactsGrantLoopTest.kt#masked verdict with DENY_STATEMENT disposition denies
	...
	// KT: StatementFactsGrantLoopTest.kt#write read-set membership of a masked column denies
	...
	// KT: StatementFactsGrantLoopTest.kt#denied verdict denies regardless of disposition
	...
	// KT: StatementFactsGrantLoopTest.kt#multi-grant same ordinal is first-wins
	...
	// KT: StatementFactsGrantLoopTest.kt#output columns and rewritten sql are preserved on the decision
	...
	// KT: StatementFactsGrantLoopTest.kt#grant with no resource fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#resource grant with a non-RESULT_READ action fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#masked verdict with an unspecified disposition fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#an out-of-range mask ordinal fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#unspecified statement class fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#unspecified statement class with a column grant fails closed independent of the verdict
	...
	// KT: StatementFactsGrantLoopTest.kt#unspecified disposition on an UNMASKED column fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#out-of-range ordinal on an UNMASKED column fails closed
	...
	// KT: StatementFactsGrantLoopTest.kt#unanalyzable deny carries schema candidates for a bounded catalog refetch
	...
	// KT: StatementFactsGrantLoopTest.kt#datasource grant with an unspecified action is a policy deny
	...
	// KT: StatementFactsGrantLoopTest.kt#ungranted table grant denies through table dispatch
	...
	// KT: StatementFactsGrantLoopTest.kt#metadata with no grants is an allow passthrough
	...
	// KT: StatementFactsGrantLoopTest.kt#session statement passes through only on persistent-connection channels
