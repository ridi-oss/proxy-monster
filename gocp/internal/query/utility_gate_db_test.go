...
func TestUtilityGateDb(t *testing.T) {
	...
	// KT: UtilityGateDbTest.kt#a data-bearing SHOW is denied on the floor and relaxed on a preset-development datasource
	...
	// KT: UtilityGateDbTest.kt#an unclassifiable utility is hard-denied even against a broad Datasource read grant
