...
// KT: ResultCryptoTest.kt#round-trips plaintext
...
// KT: ResultCryptoTest.kt#ciphertext is not the plaintext and uses a random iv
...
// KT: ResultCryptoTest.kt#tampered ciphertext fails to decrypt
...
// KT: ResultCryptoTest.kt#wrong key fails to decrypt
...
// KT: ResultCryptoTest.kt#key must be 32 bytes
...
// KT: ResultCryptoTest.kt#too-short blob is rejected
...
// KT: ResultCryptoTest.kt#empty plaintext round-trips
